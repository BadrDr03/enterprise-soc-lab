...
## Unified Public IP Enrichment

![Public IP Enrichment](../../screenshots/threat-intelligence/threat-intel-public-ip-enrichment.png)

This screenshot demonstrates enrichment of a public IP using the integrated Threat Intelligence providers.

---

## Splunk Threat Intelligence Lookup

![Splunk Threat Intel Lookup](../../screenshots/threat-intelligence/threat-intel-splunk-lookup.png)

This screenshot confirms that Splunk can read the generated Threat Intelligence CSV lookup.

---

## Real Sysmon Event Enrichment

![Real Event Enrichment](../../screenshots/threat-intelligence/threat-intel-real-event-enrichment.png)

This screenshot demonstrates correlation between a real Sysmon Event ID 3 destination IP and the Threat Intelligence lookup.
...
This screenshot demonstrates the hourly Splunk report responsible for generating the public IP list.

---

## Cron Automation

![Cron Automation](../../screenshots/threat-intelligence/threat-intel-cron-automation.png)

This screenshot demonstrates the Linux cron configuration responsible for automated Threat Intelligence enrichment.

---

## Automation Execution Log

![Automation Log](../../screenshots/threat-intelligence/threat-intel-automation-log.png)

This screenshot confirms successful execution of the automated enrichment workflow.
